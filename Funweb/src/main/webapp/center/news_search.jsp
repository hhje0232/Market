...
int listCount = testDAO.selectSearchListCount(search, searchType);
...
ArrayList<TestBean> testList = testDAO.selectSearchTestList(pageNum, listLimit, search, searchType);
...
// 				}
				...
				%>
					...
					<tr onclick="location.href='notice_content.jsp?num=<%=test.getNum() %>&page=<%=pageNum %>'">
						<td><%=test.getNum() %></td>
