...
%>
<header>
  <!-- login(member/login.jsp) join(member/join.jsp) -->
  <div id="login">
	...
	<!-- 세션 아이디가 null 이면 미로그인, 아니면 로그인 상태 -->
  	...
  	<%} else { %>
  		...
  		<!-- 만약, 세션 아이디가 "admin"일 경우 "관리자페이지" 링크 표시 -->
  		<%if(id.equals("admin")) { %>
...
<%--   	</c:choose> --%>
  ...
  <div class="clear"></div>
  <!-- 로고들어가는 곳 -->
  <div id="logo"><img src="../images/logo_market.png" width="265" height="60"></div>
  <!-- 메뉴들어가는 곳 -->
  <nav id="top_menu">
  	<ul>
  		<li><a href="../main/main.jsp">HOME</a></li>
  		<li><a href="../company/welcome.jsp">COMPANY</a></li>
  		<li><a href="../solutions/dollList.jsp">SOLUTIONS</a></li>
